...
### [1.0.2](https://github.com/plus3it/terraform-aws-tardigrade-iam-key-enforcer/releases/tag/1.0.2)

**Released**: 2025.12.30

**Summary**:

*   Add better error handling to prevent the lambda from exiting when unable to send email.
